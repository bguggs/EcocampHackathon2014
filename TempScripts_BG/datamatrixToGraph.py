...
class myGraph:
	#Creates a graph from a datamatrix. First col == id; Sec col == name of experiment; 3rd == inorg1; 4th == inorg2; 5th == org1; Last == outcmoe; Second to last == purity; In between are fully numeric, filled in columns;
